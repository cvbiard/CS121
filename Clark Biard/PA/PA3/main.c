...
int main(void)
{
	FILE*infile = fopen("input.dat", "r"),*outfile = fopen("output.dat", "w"); //Open input and output
	double gpa_mean = 0.0, cs_mean = 0.0, age_mean = 0.0, //declare double variables
	...
	int number = 5, //declare int variables
		id1 = 0, id2 = 0, id3 = 0, id4 = 0, id5 = 0,
		cs1 = 0, cs2 = 0, cs3 = 0, cs4 = 0, cs5 = 0;

	//read all the information into respective variable
	id1 = read_int(infile);
